...
class RegistrationController extends AbstractController
{
    ...
    #[Route('/register/superadmin', name: 'app_register_admin')]
    public function registerSuperAdmin(Request $request, UserPasswordHasherInterface $userPasswordHasher, Security $security, EntityManagerInterface $entityManager): Response
    {
        $user = new User();
        $form = $this->createForm(RegistrationFormType::class, $user);
        $form->handleRequest($request);
