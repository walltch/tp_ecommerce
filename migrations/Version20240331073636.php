 ...
 */
final class Version20240331073636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier ADD CONSTRAINT FK_80507DC09D86650F FOREIGN KEY (user_id) REFERENCES user (id)');
